package step1_01.print; // 1) 패키지선언문은 '항상' 첫 줄에 작성한다.
...
public class PrintEx01 {
	...
	public static void main(String[] args) { // main함수의 {}안에서 프로그래밍을 한다.
		...
		// tab으로 들여쓰기 한 이후 코드를 작성한다.
		System.out.println("=========="); // println : 자동 줄바꿈 기능(한줄 개행)
		System.out.println(" 메뉴 선택");
		System.out.println("==========");
		
		System.out.println(); // 아무내용이 없으면 줄바꿈 기능만 적용(한줄 개행)  
		System.out.println();
		System.out.println();
		...
		System.out.println();
		System.out.print("출력문1 "); // print : 줄바꿈 기능(개행)이 없음
